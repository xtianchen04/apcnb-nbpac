...
DOCS.push({
  ...
  fr: { title: "Adhésion — guide détaillé", blocks: [
    ...
    P("Pour les candidat·es en début de carrière, un stage supervisé ou une expérience pratique encadrée peut être reconnu dans le cadre de l'admission."),
  ...
  en: { title: "Membership — detailed guide", blocks: [
    ...
    P("For early-career applicants, a supervised internship or guided practical experience may be recognized as part of admission."),
...
DOCS.push({
  ...
  fr: { title: "Sondage d'intérêt — future adhésion à l'APCNB", blocks: [
    ...
    CALLOUT("Merci! Retournez ce sondage à info@apcnb.ca ou répondez en ligne sur notre site (page « Sondage »).")
  ]},
  en: { title: "Interest survey — future NBPAC membership", blocks: [
    ...
    CALLOUT("Thank you! Return this survey to info@apcnb.ca or respond online on our website (“Survey” page).")
  ]}
});
...
DOCS.push({
  ...
  fr: { title: "Sondage de consultation — orientations de l'APCNB", blocks: [
    ...
    CALLOUT("Merci de votre contribution! Retournez ce sondage à info@apcnb.ca ou répondez en ligne sur notre site (page « Consultation »).")
  ]},
  en: { title: "Consultation survey — NBPAC directions", blocks: [
    ...
    CALLOUT("Thank you for your input! Return this survey to info@apcnb.ca or respond online on our website (“Consultation” page).")
  ]}
});
