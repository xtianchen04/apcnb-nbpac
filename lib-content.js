...
DOCS.push({
  ...
  fr: { title: "Politique d'adhésion", blocks: [
    ...
    P("**Frais d'étude de dossier** : des frais de 50 $ (non remboursables) s'appliquent à l'admission des membres réguliers et associés, en plus de la cotisation; les membres étudiants en sont exemptés."),
    ...
    OL(["Soumission du formulaire d'adhésion et des pièces justificatives.", "Examen du dossier par le comité d'admission.", "Engagement écrit à respecter le Code de déontologie.", "Paiement des frais d'étude de dossier (non remboursables) et de la cotisation, puis confirmation de l'adhésion."]),
  ...
  en: { title: "Membership Policy", blocks: [
    ...
    P("**Application review fee**: a non-refundable fee of $50 applies to the admission of regular and associate members, in addition to dues; student members are exempt."),
    ...
    OL(["Submission of the membership form and supporting documents.", "Review of the file by the admissions committee.", "Written undertaking to abide by the Code of Ethics.", "Payment of the non-refundable application review fee and the dues, then confirmation of membership."]),
...
DOCS.push({
  ...
  fr: { title: "Demande d'adhésion", blocks: [
    ...
    P("Des frais d'étude de dossier de 50 $ (non remboursables) s'appliquent aux membres réguliers et associés, en plus de la cotisation; les membres étudiants en sont exemptés."),
  ...
  en: { title: "Membership Application", blocks: [
    ...
    P("A non-refundable application review fee of $50 applies to regular and associate members, in addition to dues; student members are exempt."),
...
DOCS.push({
  ...
  fr: { title: "Adhésion — guide détaillé", blocks: [
    ...
    UL(["Diplôme pertinent d'un établissement reconnu (ou inscription en cours pour les membres étudiants).", "Engagement écrit à respecter le Code de déontologie et les statuts.", "Renseignements exacts et pièces justificatives.", "Paiement des frais d'étude de dossier (non remboursables) et de la cotisation annuelle."]),
  ...
  en: { title: "Membership — detailed guide", blocks: [
    ...
    UL(["Relevant degree from a recognized institution (or current enrolment for student members).", "Written undertaking to abide by the Code of Ethics and bylaws.", "Accurate information and supporting documents.", "Payment of the non-refundable application review fee and the annual dues."]),
...
DOCS.push({
  ...
  fr: { title: "Foire aux questions", blocks: [
    ...
    P("L'adhésion étudiante est gratuite. Pour les autres catégories : 125 $ pour un membre régulier et 90 $ pour un membre associé, par année. Les membres honoraires sont aussi sans frais. Des frais d'étude de dossier de 50 $ (non remboursables) s'appliquent à l'admission des membres réguliers et associés."),
  ...
  en: { title: "Frequently asked questions", blocks: [
    ...
    P("Student membership is free. For the other categories: $125 for a regular member and $90 for an associate member, per year. Honorary members also pay no fee. A non-refundable application review fee of $50 applies to the admission of regular and associate members."),
